                    ...
                    <div className="grid lg:grid-cols-[450px,auto] gap-10">
                        ...
                        <div className="flex-1 text-slate-600 leading-loose text-justify  mx-auto font-content">
                            <p>
                                ...
                                <br />
                                <br />
                                In my artistic endeavors, I predominantly employ
                                charcoal, oil paint, and pen to capture the raw
                                emotions and intricate details of my subjects.
                                Charcoal, with its monochromatic allure, holds a
                                special place in my heart, allowing me to convey
                    ...
                    <section className="container mx-auto px-4 py-16">
                        ...
                        <div className="">
                            <div className="flex-1 text-slate-600 leading-loose text-justify font-content max-w-[75ch] mx-auto">
                                <p>
                                    In my childhood, I was captivated by the
                                    wonders of nature. Every tree, every cloud
                                    seemed like a piece of a grand puzzle, and I
                                    felt intimately connected to it all.
                                    Standing amidst the whispering woods, I'd
                                    lose myself in contemplation, feeling as
                                    though there was no distinction between
                                    myself and the natural world around me. This
                                    profound sense of unity inspired my passion
                                    for landscape painting, as I sought to share
                                    the feeling of belonging with others.
                                    <br />
                                    <br />
                                    However, life's journey took a somber turn
                                    with the sudden loss of my beloved mother.
                                    The pain of her absence brought me face to
                                    face with the harsh reality of death. It was
                                    a heartbreaking realization that shook me to
                                    my core. As I grappled with grief, I
                                    couldn't escape the inevitable truth that
                                    one day, I too would become nothing more
                                    than dust and bones.
                                    <br />
                                    <br />
                                    et, amidst the darkness, a flicker of
                                    understanding emerged. I realized that the
                                    essence of life lies not in its duration,
                                    but in the impact we leave on the world
                                    around us. This realization became the
                                    driving force behind my art. I turned to my
                                    canvas as a means of grappling with the
                                    complexities of human existence,
                                    intertwining themes of nature, humanity, and
                                    mortality.
                                    <br />
                                    <br />
                                </p>
