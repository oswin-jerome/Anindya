            ...
            <SiteLayout>
                ...
                <section className="container mx-auto px-4 py-16">
                    ...
                    <div className="grid lg:grid-cols-[450px,auto] gap-10">
                        ...
                        <div className="flex-1 text-slate-600 leading-loose text-center lg:text-justify  mx-auto font-content">
                            <p>
                ...
                <div className="bg-white">
                    <section className="container mx-auto px-4 py-16">
                        ...
                        <div className="">
                            <div className="flex-1 text-slate-600 leading-loose text-center  md:text-justify  mx-auto font-content">
                                <p>
                                    Lorem ipsum dolor sit amet consectetur. Arcu
